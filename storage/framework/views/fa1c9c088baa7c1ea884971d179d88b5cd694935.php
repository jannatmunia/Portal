      ...
      <div class="col-sm-12 col-md-12 col-md-offset-2" style=" background-color: #218838;padding:40px;"><br>
        ...
        <fieldset>
          ...
          <div class="field account-sign-in">
            <p>
              <a class="btn btn-primary btn-sm" href="<?php echo e(route('jobseekerLog')); ?>">Sign In Now</a>
            </p>
          </div>
        </fieldset>
        <div class="page-ads box">
          <form class="form-ad" action="<?php echo e(route('processjobseekerReg')); ?>" method="post" role="form">
            <?php echo csrf_field(); ?>
