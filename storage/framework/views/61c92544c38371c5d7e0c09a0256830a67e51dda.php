  ...
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-outline-success btn-sm" href="<?php echo e(route('viewJob',$data->id)); ?>">View</a>
          <a class="btn btn-outline-success btn-sm" href="<?php echo e(route('editJob',$data->id)); ?>">Edit</a>
        </td>
      </tr>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" class="optIndustrytype" name="category">
                        ...
                        <option value="<?php echo e($category->id); ?>"><?php echo e($category->job_category); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
