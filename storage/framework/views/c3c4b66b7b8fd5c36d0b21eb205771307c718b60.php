...
<head>
    ...
    <link href="<?php echo e(url('/css/dashboard/dashboard.bootstrap.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(url('/css/dashboard/dashboard.css')); ?>" rel="stylesheet">
...
<body>
<?php echo $__env->make('backend.partials.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
