    ...
    <section class="login">
      ...
      <div class="col-md-12">
          <div class="login-content">
            <form action="<?php echo e(route('registrationProcess')); ?>" method="post" role="form" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <!-- <?php if($errors->any()): ?>
          ...
          <div class="form-group is-empty">
            <div class="row">
              <div class="col-sm-12 col-md-8 col-md-offset-2" style=" background-color: #218838;padding:40px;"><br>
                <h3 class="page-title" style="text-align:center;">Sign up</h3><br>
                ...
                <div class="col-md-12 col-sm-12">
                  <label class="control-label">Password</label>
                  <input type="password" class="form-control" name=confirmed_passwrod placeholder="ABab@123" required>
                  <span class="material-input"></span>
                </div>
                <br>
                <div class="col-md-12 col-sm-12">
